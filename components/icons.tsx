...
export const SparklesIcon = ({ className = "text-2xl" }: { className?: string }) => (
  <span className={className}>✨</span>
);

export const CelebrationIcon = ({ className = "text-2xl" }: { className?: string }) => (
  <span className={className}>🎉</span>
);
...
export const LoadingSpinner = ({ className = "w-16 h-16" }: { className?: string }) => (
...
export const ErrorIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
