    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0118] via-[#1a0a2e] to-[#0a0118] flex items-center justify-center py-8 px-4" dir="rtl">
      <div className="w-full max-w-5xl">
              ...
              <div className="lg:w-80 p-6 border-b lg:border-b-0 lg:border-l border-purple-500/20 order-1 lg:order-2">
                ...
                <div className="mb-6 flex items-center gap-4">
                  ...
                  <div className="text-right flex-1 min-w-0">
                    <h1 
                      className="text-2xl text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400"
                      style={{ fontFamily: '"Codec Pro", sans-serif', fontWeight: 900 }}
                    >
                      {employee?.name || 'دخيل العنزي'}
                    </h1>
                    <p className="text-purple-300/60 text-sm">{employee?.title || 'المسؤول الرئيسي'}</p>
                  </div>
                </div>
        ...
        <div className="mt-6 flex items-center justify-center gap-2 text-purple-300 text-sm">
          ...
          <select 
            className="bg-transparent border border-purple-500/30 rounded-lg px-2 py-1 text-purple-300 text-sm focus:outline-none focus:border-purple-500 cursor-pointer"
            defaultValue={typeof window !== 'undefined' ? Intl.DateTimeFormat().resolvedOptions().timeZone : 'Asia/Riyadh'}
          >
            <option value="UTC" className="bg-[#1a0a2e]">التوقيت العالمي UTC (GMT+0)</option>
            <option value="Asia/Riyadh" className="bg-[#1a0a2e]">توقيت الرياض (GMT+3)</option>
            <option value="Asia/Dubai" className="bg-[#1a0a2e]">توقيت دبي (GMT+4)</option>
            <option value="Asia/Kuwait" className="bg-[#1a0a2e]">توقيت الكويت (GMT+3)</option>
            <option value="Africa/Cairo" className="bg-[#1a0a2e]">توقيت القاهرة (GMT+2)</option>
            <option value="Europe/London" className="bg-[#1a0a2e]">توقيت لندن (GMT+0)</option>
            <option value="America/New_York" className="bg-[#1a0a2e]">توقيت نيويورك (GMT-5)</option>
          </select>
        </div>
