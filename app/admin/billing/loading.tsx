    ...
    <div className="min-h-screen bg-[#0a0118] relative overflow-hidden" dir="rtl">
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="space-y-2">
              <div className="h-7 w-24 rounded-lg bg-purple-900/40 animate-pulse" />
              <div className="h-4 w-52 rounded-lg bg-purple-900/30 animate-pulse" />
            </div>
          </div>
          <div className="flex items-center gap-2 flex-wrap">
            <div className="h-9 w-28 rounded-xl bg-purple-900/30 animate-pulse" />
            <div className="h-9 w-28 rounded-xl bg-amber-900/20 animate-pulse" />
            <div className="h-9 w-28 rounded-xl bg-green-900/20 animate-pulse" />
        ...
        <div className="flex gap-2 mb-6">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="h-9 w-20 rounded-xl bg-purple-900/30 animate-pulse" />
          ))}
        </div>
